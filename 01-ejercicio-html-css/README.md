...
Excelente ejercicio! Realmente hubo muy poco para cambiar.
Has usado muy bien las etiquetas semánticas, y has estilado muy bien el contenido.

Hubo un cambio importante que hicimos en el header para que no se rompa el responsive, pero, mas allá de eso, el ejercicio está muy bien :)
